...
const FALLBACK = [
  { id:'quality-enhancement',number:'01',title:'质量增强',english:'QUALITY ENHANCEMENT',default_modality:'眼底彩照',modalities:['OCT','OCTA','眼底彩照'],engine:'多模态质量增强 · v2',engine_type:'pretrained_model',method:'OCT 专用模型 + OCTA / 眼底彩照自适应增强',sample_id:'quality-ultrawide-fundus',sample_url:'/research-samples/quality-ultrawide-fundus',source_url:'https://github.com/DeweiHu/OCT_DDPM',license:'MIT',output:'增强影像 + 配对 PSNR / SSIM / 边缘保持' },
