...
All avaiable datasets have be released in the repo. If you use these datasets, please cite our work and indicate source.

[MMFundus Image](https://drive.google.com/drive/folders/1gN3lzHQFECIJH1XqnY9GA5pBWCM1N0Io), [MMFundus Text](https://drive.google.com/drive/folders/12P3h_lquznr4UbH9CC3TcRqn4U9zjt_O)
...
Part of our code is adapted from [LLaMA-Adapter](https://github.com/OpenGVLab/LLaMA-Adapter) and [InternVL](https://github.com/OpenGVLab/InternVL). Thanks to these authors for their valuable works.
