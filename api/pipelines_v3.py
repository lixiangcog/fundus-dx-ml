...
CAPABILITIES = [
    {"id":"quality-enhancement","number":"01","title":"质量增强","english":"QUALITY ENHANCEMENT","modalities":["OCT","OCTA","眼底彩照"],"default_modality":"眼底彩照","engine":"多模态质量增强 · v2","engine_type":"pretrained_model","method":"OCT 专用模型 + OCTA / 眼底彩照自适应增强","license":"MIT","source_url":"https://github.com/DeweiHu/OCT_DDPM","sample_id":"quality-ultrawide-fundus","sample_url":"/research-samples/quality-ultrawide-fundus","output":"增强影像 + 配对 PSNR / SSIM / 边缘保持","status":"validated"},
